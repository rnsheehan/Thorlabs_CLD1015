...
message = 'Input: ';
newline = '\n';
prompt = strcat(newline, start, option1, option6, option7, option2, option3, option5, option4, newline, message);
...
while do
    ...
    elseif action == 4
        ...
        CLD1015_Set_LDD_Curr(visObj, Iset); 
    ...
    elseif action == 6
        ...
        % sweep the IV data
        swp_data = CLD1015_LDD_Sweep(visObj, Is, If, Iinc);
